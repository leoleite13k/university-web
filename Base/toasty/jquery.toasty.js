 ...
 (function($) {
 	...
 	Toasty.prototype = {
 		...
 		init: function(){
 			...
 			$("body").append('<div id="toasty-guy-dan"><img src="./toasty/'+ this.options.image +'" alt="toasty"></div>');
			$('#toasty-guy-dan').css('position', 'fixed');
			$('#toasty-guy-dan').css('right', '-170px');
			$('#toasty-guy-dan').css('bottom', '0px');
			if(this.options.sound){
				$("body").append('<audio id="toasty-audio"><source src="./toasty/'+ this.options.sound +'" type="audio/mpeg"></source></audio>');
 			}
 		},
